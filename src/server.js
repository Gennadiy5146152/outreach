...
async function outreachConversationExportRows(req) {
  ...
  return conversations.map((conversation) => ({
    ...
    conversation: {
      ...
      reply_reason: conversation.reply_reason,
      ai_next_best_action: conversation.ai_next_best_action,
      ai_reason: conversation.ai_reason,
      ai_confidence: conversation.ai_confidence,
      ai_updated_at: conversation.ai_updated_at,
      ai_reply_draft: conversation.ai_reply_draft,
      ai_draft_goal: conversation.ai_draft_goal,
      ai_draft_needs_user_edit: conversation.ai_draft_needs_user_edit,
    },
    messages: (byLead.get(conversation.lead_id) || []).map((message) => ({
      ...
      ai_funnel_stage: message.ai_funnel_stage,
      ai_lead_temperature: message.ai_lead_temperature,
      ai_reply_reason: message.ai_reply_reason,
      ai_next_best_action: message.ai_next_best_action,
      ai_summary: message.ai_summary,
      ai_reply_draft: message.ai_reply_draft,
      ai_draft_goal: message.ai_draft_goal,
      ai_draft_needs_user_edit: message.ai_draft_needs_user_edit,
  ...
  const result = await query(`
    ...
    LEFT JOIN LATERAL (
      SELECT COALESCE(json_agg(json_build_object(
        ...
        'ai_funnel_stage', item.ai_funnel_stage,
        'ai_lead_temperature', item.ai_lead_temperature,
        'ai_reply_reason', item.ai_reply_reason,
        'ai_next_best_action', item.ai_next_best_action,
        'ai_summary', item.ai_summary,
        'ai_reply_draft', item.ai_reply_draft,
        'ai_draft_goal', item.ai_draft_goal,
        'ai_draft_needs_user_edit', item.ai_draft_needs_user_edit,
        'outreach_step_id', item.outreach_step_id,
      ...
      FROM (
        SELECT msg.id, msg.direction, msg.status, msg.subject,
               ...
               msg.ai_reason,
               msg.ai_funnel_stage,
               msg.ai_lead_temperature,
               msg.ai_reply_reason,
               msg.ai_next_best_action,
               msg.ai_summary,
               msg.ai_reply_draft,
               msg.ai_draft_goal,
               msg.ai_draft_needs_user_edit,
