...
export const OUTREACH_COLUMN_ALIASES = {
  ...
  email: ["email", "почта", "почта получателя", "email получателя", "e-mail"],
  ...
  body: ["body", "text", "текст", "текст письма", "тело письма", "письмо"],
  body_html: ["body_html", "html", "html письма", "html письмо", "верстка письма"],
  send_after: ["send_after", "send at", "отправить после", "дата отправки"],
  followup_1_subject: ["followup_1_subject", "follow-up 1 subject", "фоллоуап 1 тема", "фоллоуап 1: тема"],
  followup_1_body: ["followup_1_body", "follow-up 1 body", "фоллоуап 1 текст", "фоллоуап 1: текст"],
  followup_1_body_html: ["followup_1_body_html", "follow-up 1 html", "фоллоуап 1 html", "фоллоуап 1: html"],
  followup_1_delay_days: ["followup_1_delay_days", "follow-up 1 delay", "фоллоуап 1 задержка", "фоллоуап 1: задержка дней"],
  followup_2_subject: ["followup_2_subject", "follow-up 2 subject", "фоллоуап 2 тема", "фоллоуап 2: тема"],
  followup_2_body: ["followup_2_body", "follow-up 2 body", "фоллоуап 2 текст", "фоллоуап 2: текст"],
  followup_2_body_html: ["followup_2_body_html", "follow-up 2 html", "фоллоуап 2 html", "фоллоуап 2: html"],
  followup_2_delay_days: ["followup_2_delay_days", "follow-up 2 delay", "фоллоуап 2 задержка", "фоллоуап 2: задержка дней"],
  followup_3_subject: ["followup_3_subject", "follow-up 3 subject", "фоллоуап 3 тема", "фоллоуап 3: тема"],
  followup_3_body: ["followup_3_body", "follow-up 3 body", "фоллоуап 3 текст", "фоллоуап 3: текст"],
  followup_3_body_html: ["followup_3_body_html", "follow-up 3 html", "фоллоуап 3 html", "фоллоуап 3: html"],
  followup_3_delay_days: ["followup_3_delay_days", "follow-up 3 delay", "фоллоуап 3 задержка", "фоллоуап 3: задержка дней"],
};
...
export function rowsToOutreachRows(rows, mapping = {}) {
  ...
  return data
    .map((row, index) => ({
      ...
      followup_1_body_html: get(row, "followup_1_body_html"),
      ...
      followup_2_body_html: get(row, "followup_2_body_html"),
      ...
      followup_3_body_html: get(row, "followup_3_body_html"),
