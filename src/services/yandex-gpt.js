  ...
  if (env.yandexGptMock) {
    ...
    return {
      text: JSON.stringify({
        ...
        funnel_stage: "details_requested",
        lead_temperature: "warm",
        reply_reason: "wants_details",
        next_best_action: "reply_manually",
        summary: "Получатель просит подробности.",
        reply_draft: "Спасибо за интерес. Пришлю подробности и уточню пару вводных: какой результат хотите получить в первую очередь?",
        draft_goal: "уточнить потребность и продолжить диалог",
