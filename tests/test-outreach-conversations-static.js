...
for (const expected of [
  ...
  "function reviewConversationPriority",
  "function conversationAiInsightText",
  "function conversationReviewReason",
  "function renderThreadAssignment",
  "function threadCandidateTitle",
  ...
  "data-thread-assign-form",
  "История решений",
  "Выбрать правильную цепочку",
  "Привязать к выбранной цепочке",
  "Выбрать цепочку",
  "Отложить follow-up",
  "Перенос follow-up",
  "Ответ привязан к цепочке",
...
for (const expected of [
  ...
  "app.get(\"/api/outreach/conversations/:id/thread-candidates\"",
  "app.post(\"/api/outreach/conversations/:id/assign-thread\"",
  ...
  "x-outreach-manual-thread-conversation-id",
